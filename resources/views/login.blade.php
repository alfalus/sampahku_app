						...
						<div class="login-form">
							...
							<form class="form" id="kt_login_singin_form" action="/login" method="POST">
                                ...
                                <div class="alert alert-custom alert-light-danger fade show mb-5" role="alert">
                                    ...
                                    <div class="alert-text">Login Gagal. Periksa <strong>email</strong>  dan <strong>password</strong>  anda!</div>
								...
								<div class="form-group">
									...
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0 @error('email') is-invalid @enderror" type="text" name="email" placeholder="nama@sampahku.com" autocomplete="off" required/>
                                    @error('email')
                                    <div class="fv-plugins-message-container"><div data-field="email" data-validator="notEmpty" class="fv-help-block">Masukkan alamat email yang valid.</div></div>
                                    @enderror
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="custom/pages/login/login-4/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary">Lupa Password ?</a>
                                </div>
								<!--end::Form group-->
								<!--begin::Action-->
