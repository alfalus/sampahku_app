                        ...
                        <form class="form" id="kt_login_singin_form" action="/login" method="POST">
                            ...
                            @error('loginFail')
                                <div class="alert alert-custom alert-light-danger fade show mb-5" role="alert">
                                    ...
                                    <div class="alert-text">Login Gagal. Periksa <strong>email</strong> dan
                                        <strong>password</strong> anda!
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    type="text" name="email" placeholder="nama@sampahku.com" autocomplete="on"
                                    required />
                                @error('email')
                                    <div class="fv-plugins-message-container">
                                        <div data-field="email" data-validator="notEmpty" class="fv-help-block">Masukkan
                                            alamat email yang valid.</div>
                                    </div>
                                @enderror
                            </div>
                            <!--end::Form group-->
