...
@section('content')
    ...
    <div class="alert alert-custom alert-notice alert-light-success fade show" role="alert">
        <div class="alert-icon"><i class="flaticon-warning"></i></div>
        <div class="alert-text">{{ session('message') }}Item sudah diperbarui</div>
        <div class="alert-close">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true"><i class="ki ki-close"></i></span>
            </button>
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Daftar Item
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/pages/crud/datatables/advanced/inventory.js') }}"></script>
    <script>
        var role = '{!! auth()->user()->id_role !!}';
        var asset = "{!! asset('assets/media/item/') !!}";
