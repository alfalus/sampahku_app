            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Daftar Nasabah Terverifikasi
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-separate table-head-custom table-checkable" id="tabel_nasabah">
                        <thead>
                            <tr>
                                <th>Nasabah</th>
                                <th>Saldo</th>
                        ...
                        <tbody>
                            ...
                            @endforeach --}}
                            <tr>
                                <td class="text-primary"> Nasabah RT 02</td>
                                <td class="w-25">Rp 75.000</td>
                                <td class="w-25"></td>
                            </tr>
    ...
    <div class="row gutter-t">
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">Riwayat Pencairan Dana Nasabah
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-separate table-head-custom table-checkable" id="tabel_riwayat">
                        <thead>
                            <tr>
                                <th>Nasabah</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            <td class="border-top-0 w-5">Nasabah</td>
                            <td class="border-top-0">: <span id="user_setor"> Nasabah RT 02</td>
                        </tr>
                        <tr>
